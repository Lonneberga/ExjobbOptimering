...
public class NetworkSolution{
	...
	static void findSolution(){
		...
		*/
		...
		Constraint totalSumCtr = new SumInt(store,vehicleDistanceArray,"==",totalDistancePrintable);
		...
		*/
		...
		if (result) {
			...
			System.out.println("Vehicle distances:");
			printArray(vehicleDistanceArray);
